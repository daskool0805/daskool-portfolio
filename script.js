...
const cats=[...document.querySelectorAll('.category')],projects=[...document.querySelectorAll('.project-name')],categoryArtStack=document.querySelector('.category-art-stack');
if(cats.length){
